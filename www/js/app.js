...
app.controller('ForgotPasswordCtrl', ['$scope', '$ionicPopup', function($scope, $ionicPopup, $timeout){
    console.log("Welcome To the forgot Password state!");
    $scope.forgotPasswordCtrl ={};
	$scope.forgotPasswordCtrl.resetPassword = function(){
		console.log("haha " + $scope.email + " You forgot you're password, sucks to be you!!" );
	};
